...
<head>
    ...
    <title>Computer Vision - Advanced Gesture Control Interface - Project Outline</title>
</head>
<body>
    <header>
        <div class = "logo">
    ...
    <div class="page-wrapper">   
		...
		<div class="main-content single">
			<h1 class="post-title">Computer Vision - Advanced Gesture Control Interface - Outline</h1>

			<center><img src="../../images/fields/computervision.jpg" alt=""></center>
			<div class="post-content">
				<center><h4>Features</h4></center>
				<p><li>Drone POV</li></p>
				<p><li>Hand Distance Optimization</li></p>
				<p><li>Gesture Optimization</li></p>
				<p><li>GPS -> Distance -> Mapping</li></p>
				<p><li>Feature Library
					<p><ul>Face Tracking</ul></p>
					<p><ul>Surveilance</ul></p>
					<p><ul>Line Following</ul></p>
				</li></p>
				<p><li>Line Drawing</li></p>
				<p><li>Shape Drawing</li></p>
				<p></p>
				<p></p>
				<p></p>
			</div>
		...
		<div class="sidebar single">
			<div class="section popular">
				...
				<div class="post clearfix">
					<img src="../../../images/projects/DronePic.jpg" alt="">
					<a href="gesture-control-interface.html" class="title"><h4>Gesture Control Interface - Overview</h4></a>
				</div>
			</div>
