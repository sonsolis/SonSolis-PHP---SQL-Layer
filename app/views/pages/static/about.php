...
<head>
    ...
    <title>Computer Vision - Roadmap</title>
</head>
<body>
    ...
    <div class="page-wrapper">   
		...
		<div class="main-content single">
			<h1 class="post-title">Mario Solis</h1>

			<center><img class="post-img" src="../../images/graduation.jpg" alt=""></center>
			<div class="post-content">
				<p>
					I graduated Class of 2025 from Monroe Community College with a degree in Computer Science. I was drawn to the field anticipating the disruption automation and technology would bring to the job market, and through the curriculum I developed a deeper appreciation for math, science, and computing. I chose computer science to gain the expertise and flexibility to adapt as technology evolves. My interests include embedded programming, computer vision, machine learning, data science, and web development.
				</p>
			</div>
		</div>
		...
		<div class="sidebar single">
			<div class="section popular">
				...
				<div class="post clearfix">
					<img src="../../images/roadmaps/Machine_Learning_Roadmap.jpg" alt="">
					<a href="mlearning.html" class="title"><h4>Machine Learning - Roadmap</h4></a>
				</div>
				<div class="post clearfix">
